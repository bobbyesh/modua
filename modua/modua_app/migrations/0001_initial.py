# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-08-26 05:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added', models.DateTimeField(editable=False, null=True)),
                ('updated', models.DateTimeField(editable=False, null=True)),
                ('country_region', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='country_region', to='modua_app.Country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added', models.DateTimeField(editable=False, null=True)),
                ('updated', models.DateTimeField(editable=False, null=True)),
                ('definitions', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='definitions', to='modua_app.Definition')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dictionary_apis', to='modua_app.DictionaryAPI'),
        ),
        migrations.AddField(
            model_name='definition',
            name='language',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='current_lang', to='modua_app.Language'),
        ),
        migrations.AddField(
            model_name='definition',
            name='target',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='target_lang', to='modua_app.Language'),
        ),
        migrations.AddField(
            model_name='definition',
        ...
        migrations.AddField(
            model_name='definition',
            name='word_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='word_type_id', to='modua_app.WordType'),
        ),
        migrations.AddField(
            model_name='city',
            name='country_city',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='country_city', to='modua_app.Country'),
        ),
        migrations.AddField(
            model_name='city',
            name='region_city',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='region_city', to='modua_app.Region'),
        ),
        migrations.AddField(
            model_name='city',
            name='user_added',
