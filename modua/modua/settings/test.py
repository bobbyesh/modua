"""
Django settings for testing the modua project.

The primary difference in this settings file is that it uses Django's
default Sqlite instead of MySql.  This is just temporary until we have
setup a way to maintain dependencies for using MySql locally as well as
in production.
